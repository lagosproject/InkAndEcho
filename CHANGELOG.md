...
### Changed
- Target Android 15 by bumping `targetSdk` and `compileSdk` to 35, complying with Google Play API level requirements.
- Bumped `versionCode` to 10 and `versionName` to 1.3.1.
